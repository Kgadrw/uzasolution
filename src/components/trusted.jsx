  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center w-full px-4">
        ...
        {/* CTA Button */}
        <button className="inline-flex items-center gap-2 bg-[#FBAF43] hover:bg-[#e59e3b] text-[#13212F] font-semibold px-6 py-3 rounded-md transition-all duration-300 group shadow-md hover:shadow-lg text-base">
          Partner with us
