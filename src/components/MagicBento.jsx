...
const cardData = [
  {
    color: '#060010',
    title: 'Annual Report',
    description: 'Comprehensive insights into our impact across Africa',
    label: 'Reports',
    image: '/story4.jpg'
  },
  {
    ...
    description: 'Detailed insights into operations and impact',
    label: 'Research',
    image: '/blog1.jpeg'
  },
  {
    ...
    description: 'Latest findings on market connection strategies',
    label: 'Insights',
    image: '/story2.png'
  },
  {
    ...
    description: 'Inspiring journeys of transformation',
    label: 'Stories',
    image: '/story3.jpg'
  },
  {
  ...
  },
  {
    color: '#060010',
    title: 'Partnerships',
    description: 'Collaborative initiatives and alliances',
    label: 'Network',
    image: '/negative.jpg'
  }
];
...
const MagicBento = ({
  ...
  particleCount = DEFAULT_PARTICLE_COUNT,
  enableTilt = false,
  glowColor = '25, 67, 109', // Using SDG blue color
  clickEffect = true,
              ...
              return (
                ...
                >
                  ...
                  <div className="card__header flex justify-between gap-3 relative text-white z-10">
                    <span className="card__label text-base font-semibold bg-[#00689D] px-3 py-1 rounded-full">{card.label}</span>
                  </div>
