            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 items-start mb-10">
              ...
              <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                <motion.div
                  ...
                  whileHover={{ y: -2 }}
                  className="bg-[#FBAF43] border-t border-black p-6 rounded-lg transition-all duration-300"
                >
                  <div className="mb-4">
            ...
            <div>
              ...
              <div>
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.6 }}
                  whileHover={{ y: -2 }}
                  className="bg-[#FBAF43] border-t border-black p-6 mb-6 rounded-lg transition-all duration-300"
                >
                  <div className="mb-4">
                    <span className="text-xs font-bold uppercase tracking-wider text-black">
                      IMPACT
