    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
      ...
      <section className="py-8 sm:py-10 md:py-12 px-4 sm:px-6 md:px-8 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 w-96 h-96 bg-[#00689D]/5 rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 right-10 w-72 h-72 bg-[#FBAF43]/5 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="max-w-xl mx-auto relative z-10">
          ...
          >
            <motion.div
              className="w-16 h-16 bg-gradient-to-br from-[#19486A] to-[#00689D] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl"
            ...
            <p className="text-sm sm:text-base text-gray-600">
              Sign in to access training, resources, and support
            </p>
          </motion.div>
